...
const SliderItem = (props) => {
  ...
  return (
    <div className='bg-white cards m-1'>
    <div className='slider-item'>
    <Link to={`/product/${id}`}><img className='pt-2' src={image} alt="" /></Link>
    <div className="off-price d-flex justify-content-around p-1 mt-2">
        <div className="item-prices d-flex flex-column justify-content-around  ">
